...
while running:
    ...
    understands = False  # Used for the bot to tell itself if it understands
    print("\n")
    # greets the user
    print(random.choice(greetings))
    # asks for how user is feeling
    phrase = input("how are you doing? ").lower().split()  # checks if user input is a recognized feeling
    # if computer recognizes user input as a positive statement
    for word in phrase:
        if word in feelings["positive"]:
        ...
        elif word in feelings["negative"]:
